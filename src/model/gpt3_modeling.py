...
class GPT3Model(torch.nn.Module):
    ...
    def __init__(self,
        ...
        print (f"in GPT3Model.__init__ we're making a VocabParallelEmbedding with vocab_size {vocab_size} and hidden_size {hidden_size}")
        ...
        # Transformer
        self.transformer = mpu.GPT3ParallelTransformer(num_layers,
                                                       hidden_size,
                                                       num_attention_heads,
                                                       attention_dropout_prob,
                                                       output_dropout_prob,
    ...
    def forward(self, input_ids, position_ids, attention_mask):
        ...
        print (f"And now we have logits_parallel {logits_parallel}")
